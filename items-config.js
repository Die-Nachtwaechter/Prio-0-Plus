const MC_items = [
    ...
    {name: "Ring des rasanten Schlags", prios: ["Krieger"]},
    {name: "Mal des Schlägers", prios: ["Schurke"]},
];
...
const AQ_items = [
    ...
    {name: "Jom Gabbar", prios: ["Krieger", "Schurke", "Jäger"]},
...
const NAXX_items = [
    ...
    {name: "Wappen des Schlächters", prios: ["Krieger", "Schurke", "Jäger"]},
