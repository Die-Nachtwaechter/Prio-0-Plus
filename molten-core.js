...
const items = [
    {name: "Sulfuron-Hammer", prios: ["Krieger", "Paladin"]},
    {name: "Galgann's Feuerhammer", prios: ["Krieger", "Jäger"]},
    {name: "Feuerblitz-Handschuhe", prios: ["Magier", "Priester"]},
    {name: "Flammenzunge", prios: ["Hexenmeister"]},
    {name: "Herz des Feuers", prios: ["Druide", "Paladin"]},
    {name: "Feuerfäuste", prios: ["Schurke", "Krieger"]},
    {name: "Schultern des Lavafürsten", prios: ["Krieger", "Paladin"]},
    {name: "Feuersturm-Umhang", prios: ["Magier", "Priester"]},
    {name: "Nachtklinge", prios: ["Schurke"]},
    {name: "Glühende Brustplatte", prios: ["Krieger", "Paladin"]}
];
